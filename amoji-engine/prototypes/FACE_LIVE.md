...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / **toast in hash** (saved views + `#flv=` + **export toast hash views**) / **saved views** (folders · stars · starred-only · bulk star · clear folder stars · prune unstarred · export starred / folder / **starred folder** · import merge starred / folder / **toast hash** filter / **inherit export meta** · drag reorder · export/import/delete/rename/duplicate/share `#flv=`) / Export / **Export toast hash** / Clear · **probe toast feedback** (mute/volume/link) persisted + **hash restore** · share audit records **toast-in-hash**
