...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / **saved views** (export/import) / Export / Clear
- **TTS speak**: Probe gateway sparkline → probe toast (**Copy / Re-probe / Dismiss**, shortcuts **c / r / esc**, **Tab** focus trap) → **Copy probe**
- **Compound emotions**: lifecycle cancelled by emotion / emblem / finger / chassis / pack / remap / surface / persona / **mood** picks
