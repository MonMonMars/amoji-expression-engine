...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / Export / Clear
- **TTS speak**: Probe gateway sparkline → probe toast (**Copy / Re-probe / Dismiss**) → **Copy probe**
- **Compound emotions**: lifecycle cancelled by emotion / emblem / finger / chassis / pack / remap / **surface** picks
