...
- **Disney Extreme**: optional cartoon deform tier — master toggle + shape × · body/head × · eyes × · mouth × (persisted); amplifies eye/brow/lid + mouth/lip/jaw morphs late in the frame; extrapolates Layer B + scales head/neck bones
