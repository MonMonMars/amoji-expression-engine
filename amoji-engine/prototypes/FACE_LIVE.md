...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / **saved views** (folders · stars · starred-only · bulk star · clear folder stars · prune unstarred · export starred / folder / **starred folder** · import merge starred / folder filter · drag reorder · export/import/delete/rename/duplicate/share `#flv=`) / Export / Clear · **probe toast feedback** (mute/volume/link) persisted
