...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / **saved views** / Export / Clear
- **TTS speak**: Probe gateway sparkline → probe toast (**Copy / Re-probe / Dismiss**, shortcuts **c / r / esc**) → **Copy probe**
- **Compound emotions**: lifecycle cancelled by emotion / emblem / finger / chassis / pack / remap / surface / **persona** picks
