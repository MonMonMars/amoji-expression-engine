...
- **Compound emotions**: lifecycle cancelled by emotion / emblem / finger / chassis / pack / remap / surface / persona / mood / smile / laugh / gaze / look / idle / spin / cycle / blink / Live Link / step-out / mood leak / improv / **auto-improv** / **stimulus** / arousal / robot walk / robot slew / latency / threat / sigh / **turn** / **speak** / **TTS play·stop·fixture·synth·http·preset·endpoint·focus·blur·tab-blur·input·paste·enter·escape** / **deliver·deliver residue·continuity residual·script hold·hold release·clear** picks
- **Layer D**: Deliver line / Clear residue / stimulus / auto improv / gap meter / **residual decay bar (emotion tint)** / continuity HUD · **residual decay + tuned morph overlay**
