...
- **Prefs**: Face Live restores from `localStorage`; share audit with filter / search / **regex** / **time range** / **saved views** (export/import/delete/rename/duplicate) / Export / Clear
- **TTS speak**: Probe gateway sparkline → probe toast (**Prev / Next / Copy / Re-probe / Pin / Dismiss**, shortcuts **[ ] c r p esc**, history stack, **Tab** focus trap, **hover pause**) → **Copy probe**
- **Compound emotions**: lifecycle cancelled by emotion / emblem / finger / chassis / pack / remap / surface / persona / mood / smile / laugh / gaze / **look** picks
