...
| `rocketbox/` | MIT (Microsoft) | `Female_Adult_01` FBX body+facial + head/body/opacity PNGs · Face Live |
| `valid-vrm/` | CC BY 4.0 (Google VALID / TLTMedia) | `Asian_F_1_Busi.glb` + ARKit 52 · Face Live |
| `../arkit/facecap.glb` | MIT (three.js) | ARKit 52 realtime reference |

Full catalog: `docs/FREE_HUMAN_HEAD_FACE.md`.
